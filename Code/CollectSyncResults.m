function [res10all, res30all] = CollectSyncResults(bAvg,bModify,bDrop,homedir)
if ~exist('bAvg','var'), bAvg = true; end
if ~exist('bModify','var'), bModify = true; end
if ~exist('bDrop','var'), bDrop = true; end

r10_1=CollateSearchData('pbs01',10,30,0,homedir);
r10_2=CollateSearchData('pbs02',10,30,0,homedir);
r10_5=CollateSearchData('pbs05',10,30,0,homedir);
r10_7=CollateSearchData('pbs07',10,30,0,homedir);
r10_8=CollateSearchData('pbs08',10,30,0,homedir);
r10_10=CollateSearchData('pbs10',10,30,0,homedir);
r10_11=CollateSearchData('pbs11',10,30,0,homedir);
r10_12=CollateSearchData('pbs12',10,30,0,homedir);
r10_13=CollateSearchData('pbs13',10,30,0,homedir);
r10_15=CollateSearchData('pbs15',10,30,0,homedir);
r10_16=CollateSearchData('pbs16',10,30,0,homedir);
r10_17=CollateSearchData('pbs17',10,30,0,homedir);

r30_1=CollateSearchData('pbs01',30,10,0,homedir);
r30_2=CollateSearchData('pbs02',30,10,0,homedir);
r30_5=CollateSearchData('pbs05',30,10,0,homedir);
r30_7=CollateSearchData('pbs07',30,10,0,homedir);
r30_8=CollateSearchData('pbs08',30,10,0,homedir);
r30_10=CollateSearchData('pbs10',30,10,0,homedir);
r30_11=CollateSearchData('pbs11',30,10,0,homedir);
r30_12=CollateSearchData('pbs12',30,10,0,homedir);
r30_13=CollateSearchData('pbs13',30,10,0,homedir);
r30_15=CollateSearchData('pbs15',30,10,0,homedir);
r30_16=CollateSearchData('pbs16',30,10,0,homedir);
r30_17=CollateSearchData('pbs17',30,10,0,homedir);
